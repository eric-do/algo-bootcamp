...
- Groups of friends that want to learn backend deployment together
- Individuals wanting to address specific technical gaps in preparation for interviews
...
| Custom workshop  | 1-2 days | TBD | A workshop catered to other topics |
...
<details>
  <summary>Suggested React topics</summary>
  <ul>
...
<details>
  ...
  <ul>
    ...
    <li>MVC pattern and application in a fullstack app</li>
    <li>How to set up a dockerized environment for testing</li>
    <li>Code reviews</li>
  </ul>
</details>
...
The above workshops are introductory and meant to get you to a place where you have sufficient knowledge to proficiently dig deeper into larger topics.

We can also do deeper dives into specific topics, such as:

- Testing: libraries, structure, workflow
- Deployment: services, containerization, continuous integration
- React: custom hooks, context, state management libraries

Some topics may require me to brush up and/or learn them so that I can teach them, so a custom workshop may take time. I won't teach a topic unless I'm confident I can do so.
